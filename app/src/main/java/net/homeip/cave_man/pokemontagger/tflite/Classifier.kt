package net.homeip.cave_man.pokemontagger.tflite
...
class Classifier(assetManager: AssetManager, modelPath: String, labelPath: String, inputSize: Int) {
    ...
    fun recognizeImage(bitmap: Bitmap): List<Recognition> {
        ...
        val outputs : ByteBuffer = ByteBuffer.allocateDirect(4 * labelList.size)
    ...
    private fun convertBitmapToByteBuffer(bitmap: Bitmap): ByteBuffer {
        ...
        for (i in 0 until INPUT_SIZE) {
            for (j in 0 until INPUT_SIZE) {
                ...
                val color1= (input.shr(16)  and 0xFF)
